  ...
  return (
    <footer className="footer">
      ...
      <div className="social-icons">
        <a href="https://github.com/arushimunjal" target="_blank" rel="noopener noreferrer"><img src="github_icon.png" alt="GitHub" /></a>
        <a href="https://www.linkedin.com/in/arushi-munjal/" target="_blank" rel="noopener noreferrer"><img src="linkedin_icon.png" alt="LinkedIn" /></a>
